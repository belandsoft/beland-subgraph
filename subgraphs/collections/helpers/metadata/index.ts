...
import { Item, NFT, Metadata } from '../../generated/schema'
import { buildEmoteItem, setItemEmoteSearchFields, setNFTEmoteSearchFields } from './emote'
import { log } from '@graphprotocol/graph-ts'
import { buildWearableItem, setItemWearableSearchFields, setNFTWearableSearchFields } from './wearable'
...
export function setItemSearchFields(item: Item): Item {
  if (item.itemType == itemTypes.WEARABLE_V1 || item.itemType == itemTypes.WEARABLE_V1 || item.itemType == itemTypes.SMART_WEARABLE_V1) {
...
export function setNFTSearchFields(nft: NFT): NFT {
  if (nft.itemType == itemTypes.WEARABLE_V1 || nft.itemType == itemTypes.WEARABLE_V1 || nft.itemType == itemTypes.SMART_WEARABLE_V1) {
