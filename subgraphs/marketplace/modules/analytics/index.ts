...
import { NFT, Sale, AnalyticsDayData } from "../../generated/schema";
...
export function updateAnalyticsDayData(sale: Sale, feesCollectorCut: BigInt): AnalyticsDayData {
  ...
  analyticsDayData.daoEarnings = analyticsDayData.daoEarnings.plus(feesCollectorCut.times(sale.price).div(ONE_MILLION));
