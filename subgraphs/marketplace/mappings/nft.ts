...
import { Transfer } from "../generated/LANDRegistry/ERC721";
import { NFT, Parcel, Estate, ENS, Wearable } from "../generated/schema";
import { isMint, getNFTId, getTokenURI, cancelActiveOrder, clearNFTOrderProperties } from "../modules/nft";
import { getCategory } from "../modules/category";
import { buildEstateFromNFT, getEstateImage } from "../modules/estate";
import { buildCountFromNFT } from "../modules/count";
import { buildParcelFromNFT, getParcelImage, getParcelText, isInBounds } from "../modules/parcel";
import { buildWearableFromNFT, getWearableImage, isWearableHead, isWearableAccessory } from "../modules/wearable";
...
export function handleTransfer(event: Transfer): void {
  ...
  let id = getNFTId(category, event.address.toHexString(), event.params.tokenId.toString());
