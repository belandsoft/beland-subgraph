...
import { OrderCreated, OrderSuccessful, OrderCancelled, Marketplace } from "../generated/Marketplace/Marketplace";
import { Order, NFT } from "../generated/schema";
...
export function handleOrderCreated(event: OrderCreated): void {
  ...
  let nftId = getNFTId(category, event.params.nftAddress.toHexString(), event.params.assetId.toString());
