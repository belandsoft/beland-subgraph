...
import { BidCreated, BidAccepted, BidCancelled, ERC721Bid } from "../generated/ERC721Bid/ERC721Bid";
...
export function handleBidCreated(event: BidCreated): void {
  ...
  let nftId = getNFTId(category, event.params._tokenAddress.toHexString(), event.params._tokenId.toString());
  let id = getBidId(
